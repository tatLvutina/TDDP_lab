...
\ESKDauthor{Разбаков~А.~А.}
\ESKDtitleAgreedBy{Доцент каф. ВСТ}{Гай В. Е.}
\ESKDtitleDesignedBy{Студент гр. 13-В-2}{Разбаков~А.~А.}
\ESKDchecker{Гай В. Е.}
\ESKDdate{2015/12/20}
...
\begin{document}
	...
	\lstset{
		...
		basicstyle=\footnotesize
       	...
       	\section{Выполнение лабораторной работы}
       		...
       		\begin{figure}[!h]
       		\centering{\includegraphics[scale = 1]{1-1}}
       		\caption{}
       		\label{ris:1-1}
       		\end{figure}
	...
	{SharedObject.cs}          
       	...
       	\begin{figure}[!h]
       		\centering{\includegraphics[scale = 1]{1-2}}
       		\caption{}
       		\label{ris:1-2}
       	\end{figure}
       	...
       	\begin{figure}[!h]
       		\centering{\includegraphics[scale = 1]{1-3}}
       		\caption{}
       		\label{ris:1-3}
       	\end{figure}
       	\newpage
       	...
       	\begin{figure}[!h]
       		\centering{\includegraphics[scale = 1]{1-4}}
       		\caption{}
       		\label{ris:1-4}
       	\end{figure}
       	       	
	\section{Вывод}
	В результате выполнения лабораторной работы был получен программный комплекс, состоящий из сервера и клиента и реализующий алгоритм умножения матрицы a(m x n элементов) на матрицу b (n x 1 элементов).
