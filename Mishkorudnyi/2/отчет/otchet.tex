...
\ESKDauthor{Мишкорудный А. И.}
\ESKDtitleAgreedBy{Доцент каф. ВСТ}{Гай В. Е.}
\ESKDtitleDesignedBy{Студент гр. 13-В-1}{Мишкорудный А. И.}
\ESKDchecker{Гай В. Е.}
\ESKDdate{2016/01/11}
    ...
    {Client.cs}  
       ...
       \newpage
        ...
        {SharedObject.cs}  
       	...
       	\begin{figure}[!h]
       		\centering{\includegraphics[scale = .7]{1-2}}
       		\caption{}
       		\label{ris:1-2}
       	\end{figure}
       	\newpage
       	...
       	\begin{figure}[!h]
       		\centering{\includegraphics[scale = .7]{1-3}}
       		\caption{}
       		\label{ris:1-3}
       	\end{figure}
       	\newpage
       	...
       	\begin{figure}[!h]
       		\centering{\includegraphics[scale = 0.9]{1-4}}
       		\caption{}
       		\label{ris:1-4}
       	\end{figure}
