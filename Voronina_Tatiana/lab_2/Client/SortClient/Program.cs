...
namespace SortClient
{
    class Shell
    {
        ...
        public int sort()
        {
            ...
            arr = obj.FetchData(task);
                ...
                Console.Out.WriteLine("Полученные клиентом данные:");
                display();
                ...
                Console.Out.WriteLine("Найденные элементы в полученных данных \tMax: " + max + ". Min: " + min);
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.Out.WriteLine("Завершение работы. Нажмите любую клавишу для продолжения...");
            Console.ReadLine();
