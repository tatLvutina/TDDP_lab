...
\ESKDauthor{Смирнов~А.~В.}
\ESKDtitleAgreedBy{Доцент каф. ВСТ}{Гай В. Е.}
\ESKDtitleDesignedBy{Студент гр. 13-В-1}{Смирнов~А.~В.}
\ESKDchecker{Гай В. Е.}
\ESKDdate{2015/12/11}
    ...
    {Client.cs}  
       ...
       \newpage
        ...
        {SharedObject.cs}  
       	...
       	\begin{figure}[!h]
       		\centering{\includegraphics[scale = .5]{1-2}}
       		\caption{}
       		\label{ris:1-2}
       	\end{figure}
       	...
       	\begin{figure}[!h]
       		\centering{\includegraphics[scale = .5]{1-3}}
       		\caption{}
       		\label{ris:1-3}
       	\end{figure}
       	\newpage
       	...
       	\begin{figure}[!h]
       		\centering{\includegraphics[scale = .6]{1-4}}
       		\caption{}
       		\label{ris:1-4}
       	\end{figure}
