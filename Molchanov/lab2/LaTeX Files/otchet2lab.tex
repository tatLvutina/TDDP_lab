...
\ESKDauthor{Молчанов~М.~Н.}
\ESKDtitleAgreedBy{Доцент каф. ВСТ}{Гай В. Е.}
\ESKDtitleDesignedBy{Студент гр. 13-В-2}{Молчанов~М.~Н.}
\ESKDchecker{Гай В. Е.}
\ESKDdate{2015/12/28}
...
\begin{document}
	...
	\lstset{
		...
		basicstyle=\footnotesize
       	...
       	\section{Выполнение лабораторной работы}
       		...
       		Вариант 15:
       		\begin{figure}[h!]
       			\centering{\includegraphics[scale = 1.0]{1-1}}
    ...
    {Client.cs}  
        ...
        {SharedObject.cs}  
       	...
       	\begin{figure}[!h]
       		\centering{\includegraphics[scale = 1.0]{1-2}}
       		\caption{}
       		\label{ris:1-2}
       	\end{figure}
       	\newpage
       	...
       	\begin{figure}[!h]
       		\centering{\includegraphics[scale = 1.0]{1-3}}
       		\caption{}
       		\label{ris:1-3}
       	\end{figure}
       	...
       	\begin{figure}[!h]
       		\centering{\includegraphics[scale = 1.0]{1-4}}
       		\caption{}
       		\label{ris:1-4}
       	\end{figure}
